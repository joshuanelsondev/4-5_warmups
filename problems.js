...
// Write a function that takes a string as input and returns the number of vowels in
// the string (a, e, i, o, u).
...
// Write a function that takes an array of consecutive (increasing) numbers starting
// from 1 and returns the missing number in the sequence.
...
function findMissingNumber(arr) {
  ...
  for (let idx = 1; idx < arr.length; idx++) {
    const lastVal = arr[idx - 1];
    const currentVal = arr[idx];
    if (lastVal + 1 != currentVal) {
      return idx + 1;
    }
  }
}
...
// Write a function that takes a completed sudoku puzzle represented as a 9x9
// matrix and returns true if the puzzle is valid, false otherwise.
...
// Write a function that takes two strings and returns the length of the longest
// common subsequence.

function longestCommonSubsequence(text1, text2) {
  //   const size = text1.length >= text2.length ? text2.length : text2.length;
  //   let longest = 0;
  //   for (let idx = 0; idx < size; idx++) {
  //     const char1 = text1[idx];
  //     const char2 = text2[idx];
  //     if (char1 == char2) {
  //       longest++;
  //     } else if (longest > 0) {
  //       return longest;
